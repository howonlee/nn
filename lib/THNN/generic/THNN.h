...
TH_API void THNN_(LNL_updateOutput)(
          ...
          THTensor *input,             // input tensor
          THTensor *output,
          real alpha);           // [OUT] Abs output
TH_API void THNN_(LNL_updateGradInput)(
          THNNState *state,            // library's state
          THTensor *input,             // input tensor
          THTensor *gradOutput,        // gradient w.r.t. output
          THTensor *gradInput,
          real alpha);        // [OUT] gradient w.r.t. input

TH_API void THNN_(Rack_updateOutput)(
          THNNState *state,            // library's state
          THTensor *input,             // input tensor
          THTensor *output,
          real alpha);           // [OUT] Abs output
TH_API void THNN_(Rack_updateGradInput)(
          THNNState *state,            // library's state
          THTensor *input,             // input tensor
          THTensor *gradOutput,        // gradient w.r.t. output
          THTensor *gradInput,
...
TH_API void THNN_(xor_updateOutput)(
          THNNState *state,            // library's state
          THTensor *input,             // input tensor
          THTensor *output,
          real alpha);           // [OUT] Abs output
TH_API void THNN_(xor_updateGradInput)(
          THNNState *state,            // library's state
          THTensor *input,             // input tensor
          THTensor *gradOutput,        // gradient w.r.t. output
          THTensor *gradInput,
...
TH_API void THNN_(HarmLU_updateOutput)(
          THNNState *state,            // library's state
          THTensor *input,             // input tensor
          THTensor *output,            // [OUT] HarmLU output
          real alpha,                  // an HarmLU parameter (like ELU param)
          bool inplace);               // if true, modifies gradOutput and sets gradInput onto it (no additional memory is allocated)
TH_API void THNN_(HarmLU_updateGradInput)(
          THNNState *state,            // library's state
          THTensor *input,             // input tensor
          THTensor *gradOutput,        // gradient w.r.t. output
          THTensor *gradInput,         // [OUT] gradient w.r.t. input
